...
export const schema = z.object({
  organizerSchool: z.string().min(1, "Selecione uma escola"),
  organizerId: z.string().min(8).optional(), //organizador id será passado como default. Opcional serve apenas para não dar erro
