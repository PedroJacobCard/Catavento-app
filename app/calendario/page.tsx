        ...
        {user?.role?.toString() !== "VOLUNTARIO_A" ? (
          <button
            ...
            className={`flex items-center w-[8rem] ${
              events && events?.length < 1 ? "mt-[9rem] md:mt-[5rem]" : "mt-5"
            } gap-3 m-auto py-1 px-2 shadow-md dark:bg-darkMode bg-primaryBlue rounded-md dark:hover:bg-darkModeBgColor hover:bg-secondaryBlue duration-300`}
